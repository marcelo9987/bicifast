...
import com.bicisoft.bicifast.control.GestorBicicleta;
import com.bicisoft.bicifast.control.GestorEstacion;
import com.bicisoft.bicifast.control.GestorUsuario;
...
public final class FachadaAplicacion {
    ...
    public FachadaAplicacion() {
        ...
        // -- CONTROLADORES --
        this.controladorUsuario = new GestorUsuario(fbd);
        this.controladorEstacion = new GestorEstacion(fbd);
        this.controladorBicicleta = new GestorBicicleta(fbd);
    ...
    public void lanzarAplicacion() {
        System.out.println("[INFO] Iniciando la aplicación...");
    ...
    public List<Bicicleta> obtenerBicisLibresPorEstacion(Estacion estacionUsada) {
        return this.controladorBicicleta.obtenerBicisLibresPorEstacion(estacionUsada);
    }
